...
const From = () => {
  return (
    ...
    <div className='flex flex-row items-center justify-evenly mt-5' >
      <div className='flex justify-center items-center bg-gray-400 rounded-full h-24 w-48 mr-4'>
    ...
    <div className='flex flex-row items-center justify-evenly mt-5'>
      <div  className='flex justify-center items-center bg-gray-400 rounded-full  h-24 w-44 mr-4'>
