...
const From = () => {
  return (
    <div className='flex flex-row w-full'>
      <div className='flex flex-col w-[2000px]  pl-24 mt-8'>
   ...
   <div className='flex flex-col  items-center bg-black w-full ml-16 mr-16 mt-10'>
  <p className='font-bold text-4xl text-white mt-4'>Get A Free Estimate</p>
...
<p className='text-sm text-white -ml-24 mt-1'>By submitting this form, you are agreeing to the privacy policy.</p>
